...
public class CMIGCraftingMonitorScreen extends CraftingMonitorScreen
{
	...
	public CMIGCraftingMonitorScreen(CraftingMonitorContainer container, PlayerInventory inventory, CCraftingMonitorOpenResultMessage message, Screen parent)
	{
	...
	public void onPostInit(int x, int y)
	{
		...
		TabListWidget<CraftingMonitorContainer> tabs = extension.rs_cmig$getTabs();
